...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH,  EFFECT_SPEED_DOWN_HIT,     60, GROUND,       100, 20, 100
	...
	move RAZOR_WIND,   EFFECT_NORMAL_HIT,        100, ROCK,          80,  5,   0
	...
	move TWINEEDLE,    EFFECT_ATTACK_DOWN_HIT,    80, BUG,          100, 15, 100
	...
	move SUBMISSION,   EFFECT_FLING,              60, DARK,         100, 10,   0
	...
	move RAGE,         EFFECT_ECHOED_VOICE,       40, NORMAL,        100, 15,   0
	...
	move BONE_CLUB,    EFFECT_PRIORITY_HIT,       40, STEEL,        100, 30,   0
	...
	move CONSTRICT,    EFFECT_CONFUSE_HIT,        75, BUG,          100, 15,  10
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE, 100, 20,   0
	move KINESIS,      EFFECT_NORMAL_HIT,         40, FAIRY,        100, 30,   0
	...
	move BARRAGE,      EFFECT_DRAINING_KISS,      50, FAIRY,        100, 10,   0
	...
	move PSYWAVE,      EFFECT_SP_ATK_DOWN_HIT,    55, GHOST,        100, 15, 100
	move SPLASH,       EFFECT_FLINCH_HIT,         30, GHOST,        100, 30,  30
	...
	move HYPER_FANG,   EFFECT_FAKE_OUT,           40, NORMAL,       100, 10,   0
	move SHARPEN,      EFFECT_RECYCLE,             0, NORMAL,       100, 10,   0
	...
	move IRON_TAIL,    EFFECT_FLINCH_HIT,         80, STEEL,        100, 15,  30
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       100, PSYCHIC_TYPE,  90, 15,   0
	...
	move MOON_BLAST,   EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,        100, 15,  30
