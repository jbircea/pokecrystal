...
FalknerGroup:
	...
	db 12, NOCTOWL,   SPLASH, PECK, FORESIGHT, HYPNOSIS
	db -1 ; end
...
BugCatcherGroup:
	...
	db 24, DWEBBLE, FURY_CUTTER, ROCK_SMASH, SAND_ATTACK, PROTECT
	...
	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db 34, CRUSTLE, FURY_CUTTER, ROCK_SMASH, CLAMP, ANCIENTPOWER
	db 30, BEEDRILL, FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 30, ARIADOS, SPIDER_WEB, NASTY_PLOT, CONSTRICT, PSYCHIC_M
	db -1 ; end
