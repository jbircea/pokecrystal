...
FalknerGroup:
	...
	db 9, PIDGEY,     TACKLE, MUD_SLAP, GUST, SAND_ATTACK
	db 9, NATU,       PECK, LEER, NIGHT_SHADE, FLASH
	db 11, NOCTOWL,   SPLASH, PECK, MUD_SLAP, HYPNOSIS
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 20, AIPOM,      PSNCUREBERRY, SHARPEN, SUBMISSION, HYPER_FANG, BATON_PASS
	db 20, JIGGLYPUFF, NO_ITEM,      SING, BARRAGE, ROLLOUT, POUND
	db 20, FURRET,     PRZCUREBERRY, QUICK_ATTACK, SUBMISSION, ICE_PUNCH, THIEF
	db 22, MILTANK,    MINT_BERRY,   ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 16, SUNKERN,    WATER_GUN, QUICK_ATTACK, SWEET_SCENT, LEECH_LIFE
	db 16, YANMA,      LEECH_LIFE, WHIRLWIND, QUICK_ATTACK, SUPERSONIC
	db 16, BUTTERFREE, CONFUSION, SLEEP_POWDER, POISONPOWDER, PROTECT
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, PURSUIT
	db -1 ; end
...
MortyGroup:
	...
	db 23, CORSOLA,    BONE_RUSH, DISABLE, CURSE, RECOVER
	db 25, HAUNTER,    HYPNOSIS, PSYWAVE, MEAN_LOOK, NIGHT_SHADE
	db 23, MISDREAVUS, PSYWAVE, CONFUSE_RAY, PAIN_SPLIT, DESTINY_BOND
...
PryceGroup:
	...
	db 33, DEWGONG,    FISSURE, LICK, ICY_WIND, RAGE 
	db 33, DELIBIRD,   PRESENT, ICY_WIND, ROOST, TOXIC
	db 34, SNEASEL,    FAINT_ATTACK, QUICK_ATTACK, ROCK_SMASH, MUD_SLAP
	db 34, LAPRAS,     ICE_BEAM, PERISH_SONG, CONFUSE_RAY, SURF
	db 35, PILOSWINE,  ICY_WIND, EARTHQUAKE, MIST, ANCIENTPOWER
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 31, FORRETRESS, SPIKES, RAPID_SPIN, PIN_MISSILE, SELFDESTRUCT
	db 30, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 30, SKARMORY,   DRILL_PECK, STEEL_WING, WHIRLWIND, ROOST
	db 31, SCIZOR,     BONE_CLUB, SWORDS_DANCE, FURY_CUTTER, WING_ATTACK
	db 33, STEELIX,    SCREECH, SANDSTORM, EARTHQUAKE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 29, HITMONTOP,  RAPID_SPIN, PURSUIT, QUICK_ATTACK, ROLLING_KICK
	db 29, MACHOKE,    LOW_KICK, STRENGTH, THUNDERPUNCH, VITAL_THROW
	db 29, HERACROSS,  HORN_ATTACK, FURY_CUTTER, HARDEN, BONEMERANG
	db 30, PRIMEAPE,   LEER, ROCK_SLIDE, KARATE_CHOP, BONEMERANG
...
ClairGroup:
	...
	db 39, DUNSPARCE, DRAGON_RAGE, ROOST, GLARE, ANCIENTPOWER
	db 39, DRAGONAIR,  THUNDER_WAVE, SURF, RAIN_DANCE, DRAGONBREATH
	db 39, DRAGONAIR,  THUNDER_WAVE, THUNDER, RAIN_DANCE, DRAGONBREATH
	db 39, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, RAIN_DANCE, DRAGONBREATH
	db 38, MAROWAK,    DRAGONBREATH, ROOST, BARRAGE, SING
	db 41, KINGDRA,    SMOKESCREEN, SURF, ICE_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 21, TEDDIURSA,  LICK, FAINT_ATTACK, SNORE, ROAR
	db 21, ONIX,       COMET_PUNCH, ROCK_THROW, BIND, SCREECH
	db 20, HITMONTOP,  RAPID_SPIN, ROLLING_KICK, QUICK_ATTACK, PURSUIT
	...
	db 21, ONIX,       COMET_PUNCH, ROCK_THROW, BIND, SCREECH
	db 20, HITMONTOP,  RAPID_SPIN, ROLLING_KICK, QUICK_ATTACK, PURSUIT
	db 23, CROCONAW,   LEER, FLAIL, WATER_GUN, BITE
	db -1 ; end
...
YoungsterGroup:
	...
	db 21, FURRET,  QUICK_ATTACK, DEFENSE_CURL, TOXIC, PROTECT
	db 21, NOCTOWL, SPLASH, PECK, HYPNOSIS, REFLECT
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, FURRET, QUICK_ATTACK, DEFENSE_CURL, TOXIC, PROTECT
	db 30, NOCTOWL, REFLECT, HYPNOSIS, CONFUSION, PECK
	db 25, POLIWHIRL, BUBBLEBEAM, HYPNOSIS, ICE_PUNCH, REST
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, FURRET, QUICK_ATTACK, TOXIC, PROTECT, SLAM
	db 37, NOCTOWL, HYPNOSIS, CONFUSION, ROOST, STEEL_WING
	db 35, POLITOED, SURF, PERISH_SONG, HYPNOSIS, ICE_PUNCH
	db -1 ; end
...
BugCatcherGroup:
	...
	; BUG_CATCHER (13)
	db "ARNIE@", TRAINERTYPE_NORMAL
	db 21, LEDIAN, REFLECT, LIGHT_SCREEN, BATON_PASS, MACH_PUNCH
	db 21, PINSIR, VICEGRIP, HARDEN, SEISMIC_TOSS, ROCK_SMASH
	db 21, YANMA, SUPERSONIC, DOUBLE_TEAM, QUICK_ATTACK, TACKLE
	db -1 ; end

	; BUG_CATCHER (14)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 28, LEDIAN, REFLECT, LIGHT_SCREEN, BATON_PASS, MACH_PUNCH
	db 28, PINSIR, VICEGRIP, HARDEN, SEISMIC_TOSS, ROCK_SMASH
	db 28, YANMA, SUPERSONIC, DOUBLE_TEAM, QUICK_ATTACK, TACKLE
	db -1 ; end

	; BUG_CATCHER (15)
	db "WADE@", TRAINERTYPE_MOVES
	db 28, SUNKERN, SPIDER_WEB, BUBBLEBEAM, RAPID_SPIN, TOXIC
	db 24, SUNFLORA, BUBBLEBEAM, LEECH_LIFE, GUST, QUICK_ATTACK
	db 25, BUTTERFREE, CONFUSION, SLEEP_POWDER, STUN_SPORE, GUST
	db 24, ARIADOS, SPIDER_WEB, POISON_STING, CONSTRICT, NIGHT_SHADE
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 38, SUNFLORA, SPIDER_WEB, HYDRO_PUMP, TOXIC, TWINEEDLE
	db 34, SUNFLORA, CONSTRICT, BUBBLEBEAM, GUST, AGILITY
	db 34, BUTTERFREE, CONSTRICT, SLEEP_POWDER, STUN_SPORE, WHIRLWIND
	db 34, ARIADOS, SPIDER_WEB, NASTY_PLOT, CONSTRICT, PSYCHIC_M
	db -1 ; end

	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 34, LEDIAN, REFLECT, LIGHT_SCREEN, BATON_PASS, TWINEEDLE
	db 34, PINSIR, VICEGRIP, TWINEEDLE, SEISMIC_TOSS, ROCK_SMASH
	db 34, YANMA, SUPERSONIC, WING_ATTACK, QUICK_ATTACK, CONSTRICT
	db 36, VENOMOTH, CONSTRICT, STUN_SPORE, PSYBEAM, DISABLE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 38, LEDIAN, REFLECT, LIGHT_SCREEN, BATON_PASS, TWINEEDLE
	db 38, PINSIR, VICEGRIP, TWINEEDLE, SEISMIC_TOSS, ROCK_SMASH
	db 38, YANMA, SUPERSONIC, WING_ATTACK, QUICK_ATTACK, CONSTRICT
	db 40, VENOMOTH, CONSTRICT, STUN_SPORE, PSYCHIC_M, SLEEP_POWDER
	db -1 ; end
...
FisherGroup:
	...
	db 39, POLIWRATH, SUBMISSION, BODY_SLAM, BELLY_DRUM, QUICK_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 18, DWEBBLE,    ROCK_SMASH, PROTECT, MUD_SLAP, CUT
...
HikerGroup:
	...
	db 36, SANDSLASH,      MAGNITUDE, ROLLOUT, DEFENSE_CURL, METAL_CLAW
	db 34, CRUSTLE,    CLAMP, ANCIENTPOWER, FURY_CUTTER, PROTECT
	db -1 ; end
