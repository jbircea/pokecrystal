...
PryceGroup:
	...
	db 34, DEWGONG,    REST, LICK, ICY_WIND, DISABLE 
	db 34, DELIBIRD,   PRESENT, ICY_WIND, ROOST, TOXIC
	db 35, SNEASEL,    FAINT_ATTACK, QUICK_ATTACK, ROCK_SMASH, MUD_SLAP
	db 35, LAPRAS,     ICE_BEAM, PERISH_SONG, CONFUSE_RAY, SURF
	db 36, PILOSWINE,  ICY_WIND, EARTHQUAKE, MIST, ANCIENTPOWER
	db -1 ; end
