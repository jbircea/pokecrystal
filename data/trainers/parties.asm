...
FalknerGroup:
	...
	db 10, PIDGEY,    TACKLE, MUD_SLAP, GUST, SAND_ATTACK
	db 10, NATU,      PECK, LEER, NIGHT_SHADE, FLASH
	db 12, NOCTOWL,   SPLASH, PECK, MUD_SLAP, HYPNOSIS
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 20, AIPOM,      SAND_ATTACK, FURY_SWIPES, AGILITY, BATON_PASS
	db 20, JIGGLYPUFF, SING, DISABLE, ROLLOUT, POUND
	db 20, FURRET,     QUICK_ATTACK, DEFENSE_CURL, ICE_PUNCH, THIEF
...
BugsyGroup:
	...
	db 16, SUNKERN,    BUBBLE, QUICK_ATTACK, SWEET_SCENT, LEECH_LIFE
	db 16, YANMA,      LEECH_LIFE, WHIRLWIND, QUICK_ATTACK, SUPERSONIC
	db 16, DWEBBLE,    FURY_ATTACK, SAND_ATTACK, MUD_SLAP, ROCK_SMASH
...
MortyGroup:
	...
	db 23, CORSOLA,    SPLASH, DISABLE, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 25, MISDREAVUS, SPLASH, CONFUSE_RAY, PAIN_SPLIT, DESTINY_BOND
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 33, DEWGONG,    REST, LICK, ICY_WIND, DISABLE 
...
JasmineGroup:
	...
	db 31, SKARMORY,   DRILL_PECK, CURSE, WHIRLWIND, ROOST
	db 33, SCIZOR,     METAL_CLAW, SWORDS_DANCE, BATON_PASS, WING_ATTACK
	db 33, AMPHAROS,   THUNDERPUNCH, THUNDER_WAVE, LIGHT_SCREEN, IRON_TAIL
	db 35, STEELIX,    SCREECH, SANDSTORM, EARTHQUAKE, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 29, HERACROSS,  HORN_ATTACK, COUNTER, HARDEN, ROCK_SMASH
	db 29, PRIMEAPE,   LEER, ROCK_SLIDE, KARATE_CHOP, FURY_SWIPES
	db 29, MACHAMP,    LOW_KICK, STRENGTH, THUNDERPUNCH, KARATE_CHOP
...
ClairGroup:
	...
	db 38, GYARADOS,    BITE, RAIN_DANCE, DRAGON_RAGE, WATERFALL
