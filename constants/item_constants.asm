...
; Custom TM replacements
REDEF TM12_MOVE = BARRAGE      ; DRAIN KISS
REDEF TM13_MOVE = RAGE         ; ECHOED VOICE
REDEF TM20_MOVE = SHARPEN      ; RECYCLE
REDEF TM34_MOVE = PSYWAVE      ; RUMUR
REDEF TM40_MOVE = RAZOR_WIND   ; STONE EDGE

; Compatibility aliases for the replacement moves
DEF BARRAGE_TMNUM EQU SWEET_SCENT_TMNUM
DEF RAGE_TMNUM EQU SNORE_TMNUM
DEF SHARPEN_TMNUM EQU ENDURE_TMNUM
DEF PSYWAVE_TMNUM EQU SWAGGER_TMNUM
DEF RAZOR_WIND_TMNUM EQU DEFENSE_CURL_TMNUM
